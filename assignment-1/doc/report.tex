...
This report discusses the implementation of a digital emulation \cite{Stilson1996} of a Moog voltage-controlled filter. The overall structure of this filter is depicted in \Cref{fig:overall-structure}.
...
\begin{figure}
	...
	\caption{Filter responses for polynomial fit of parameter $g$ (see \Cref{eq:polynom-fit})}
	\label{fig:ext-resp}
\end{figure}
